        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CICS</span>
<?php
include_once('../controller/config.php');

$sql1="SELECT count(id) FROM cics WHERE _status=''";
$total_count1=0;
    ...
    <span class="info-box-number"></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CONAHS</span>

<?php
include_once('../controller/config.php');

$sql1="SELECT count(id) FROM conahs WHERE _status=''";
$total_count1=0;
...
<span class="info-box-number"></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CAS</span>

<?php
include_once('../controller/config.php');

$sql1="SELECT count(id) FROM cas WHERE _status=''";
$total_count1=0;
...
<span class="info-box-number"></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CABHEIM</span>

<?php
include_once('../controller/config.php');

$sql1="SELECT count(id) FROM cabheim WHERE _status=''";
$total_count1=0;
...
<span class="info-box-number"></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">CTE</span>

<?php
include_once('../controller/config.php');

$sql1="SELECT count(id) FROM cte WHERE _status=''";
$total_count1=0;
...
?> 
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Violations</span>
<?php
include_once('../controller/config.php');
$current_year=date("Y");
